    ...
    j = () => {
      ...
      let l = () => {
        4 == ++a &&
          ...
          (B = N = h.rotation.y),
          (S = "front"),
          et("./assets/fabric_optimized/All Fabrics/A52024006- $850.webp"),
          (function e() {
...
`;
  ...
  function K(e) {
    ...
    let s = l[e];
    if (Array.isArray(s))
      Z(e, null, "./assets/fabric_optimized/All Fabrics/", s);
    else {
      let n;
      if (
        window.matchMedia("(max-width: 1024.9px)").matches &&
        ...
        let i = s[t],
          o = (function e(t, a, s, n) {
            ...
            r.forEach((e) => {
              ...
              let n = `./assets/fabric_optimized/${t}/${a}/`;
              (s.src = n + e),
                (s.alt = e),
                (s.style.touchAction = "pan-y;"),
                o.appendChild(s);
    ...
    <path d="M250.606,154.389l-150-149.996c-5.857-5.858-15.355-5.858-21.213,0.001  
       ...
       C255,161.018,253.42,157.202,250.606,154.389z" style="touch-action: pan-y;"></path>
              ...
              i.appendChild(p),
              i.addEventListener("click", () => {
                let e = `./assets/fabric_optimized/${t}/${a}/`;
                Z(t, a, e, s);
              }),
              i
            );
