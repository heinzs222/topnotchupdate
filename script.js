...
document.addEventListener("DOMContentLoaded", function () {
  ...
  let L = {},
    ...
    B = "front",
    j = () => {
      ((u = new BABYLON.Scene(w)).clearColor = new BABYLON.Color3(1, 1, 1)),
      ...
      let a = 0,
        l = () => {
          4 == ++a &&
            ...
            (S = N = g.rotation.y),
            (B = "front"),
            es("./assets/fabric/All Fabrics/A52024006- $850.webp"),
            (function e() {
...
`;
  ...
  function V(e) {
    ...
    e$(s, { paused: !0, draggable: !0, speed: 2, snap: 1, repeat: -1 }),
    ...
    `
        ...
        `;
          ...
          d.embroidery.jacket.forEach((e, t) => {
            ...
            i &&
              i.addEventListener("click", () => {
                d.embroidery.jacket.splice(t, 1), Y(4);
              });
          });
        break;
      case 5:
  ...
  function Z(e) {
    ...
    (a.textContent = "Back"),
      ...
      t.appendChild(a);
    let s = l[e];
    if (Array.isArray(s)) J(e, null, "./assets/fabric/All Fabrics/", s);
    else {
      let n;
      if (
        window.matchMedia("(max-width: 1024.9px)").matches &&
  ...
  function et(e, t, a, s) {
    ...
    n && n.classList.add("selected"), es(s + t), (d.texture = t);
  }
  function ee(e) {
    return e.replace(/_/g, " ").replace(".png", "");
  }
  ...
  function er(e) {
    ...
    if (
        ...
        if (t.classList.contains(l)) {
          t.classList.remove(l),
            ...
            el.includes(s)
              ...
              : ec.includes(s) && (d.design.jacket.PocketsBottom = void 0),
            ep(s);
          return;
        }
      }
      ...
      if (
        ...
        m && !m.classList.contains("active") ? m.click() : eo();
      }
    }
  }
  (u = j()),
    ...
    if (window.matchMedia("(max-width: 1024.9px)").matches) {
      ...
      r
        ? d.design.jacket.PocketsTop === t
          ...
          : (el.forEach((e) => ep(e)), em(t), (d.design.jacket.PocketsTop = t))
        : l &&
          (d.design.jacket.PocketsBottom === t
  ...
  function e$(e, t) {
    ...
    for (
      ...
      (k = e[_]),
        (g = (r[_] / 100) * o[_]),
        ($ = (h = k.offsetLeft + g - n) + o[_] * gsap.getProperty(k, "scaleX")),
        a
          .to(k, { xPercent: d(((g - $) / o[_]) * 100), duration: $ / c }, 0)
          .fromTo(
            k,
            { xPercent: d(((g - $ + u) / o[_]) * 100) },
            {
              xPercent: r[_],
              duration: (g - $ + u - g) / c,
              immediateRender: !1,
  ...
  function e_() {
    ...
    e.forEach((e) => {
      ...
      let t = gsap.utils.toArray(".card_cardContainer", e),
        a = e$(t, { paused: !0, draggable: !0, speed: 2, snap: 1 });
      a.progress(0, !1),
        gsap.set(e, { x: 0 }),
...
`;
  ...
  let e3 = document.getElementById("arrow");
  e3
