      ...
      let a = 0,
        l = () => {
          4 == ++a &&
            ...
            (S = N = g.rotation.y),
            (B = "front"),
            en("./assets/fabric/All Fabrics/A52024006- $850.webp"),
            (function e() {
...
`;
  ...
  function F() {
    ...
    let e = (o - (g.rotation.y - N)) % (2 * Math.PI);
  ...
  function V(e) {
    ...
    ek(s, { paused: !0, draggable: !0, speed: 2, snap: 1, repeat: -1 }),
  ...
  function G() {
    ...
    (s.textContent = "Top Pockets"),
      ...
      s.addEventListener("click", () => {
        console.log("Top pockets button clicked"), ep("top");
      });
    let n = document.createElement("button");
    (n.textContent = "Bottom Pockets"),
      n.classList.add("top-bottom-btns"),
      n.addEventListener("click", () => {
        console.log("Bottom pockets button clicked"), ep("bottom");
      }),
      a.appendChild(s),
      a.appendChild(n),
      e.appendChild(a);
  ...
  function Y(e) {
    if (window.matchMedia("(max-width: 1024.9px)").matches) J(e);
    else {
      let t = document.getElementById("sidePanel"),
        a = t.querySelector(".widescreen-step");
      a
        ? gsap.to(a, {
            x: window.innerWidth,
            duration: 0.5,
  ...
  <path d="M202.82861,197.17188a3.99991,3.99991,0,1,1-5.65722,5.65624L128,133.65723,58.82861,202.82812a3.99991,3.99991,0,0,1-5.65722-5.65624L122.343,128,53.17139,58.82812a3.99991,3.99991,0,0,1,5.65722-5.65624L128,122.34277l69.17139-69.17089a3.99991,3.99991,0,0,1,5.65722,5.65624L133.657,128Z"/>
    ...
    `
      ...
      `);
        let g = document.getElementById("pantsMeasurementWrapper");
    ...
    !(function e(t) {
      ...
      let n = document.createElement("div");
      for (n.classList.add(`step-${t}-ws`, "widescreen-step"); a.firstChild; )
  ...
  function Z(e, t, a, s) {
    ...
    (o.className = "cards-wrapper"),
      ...
      n.appendChild(o),
      window.matchMedia("(max-width: 1024.9px)").matches && e_();
  }
  function K(e) {
    let t = document.getElementById("textureContainer");
    t.innerHTML = "";
  ...
  function ee(e, t, a, s) {
    let n = document.createElement("div");
    (n.className = "card_cardContainer card_small"),
      (n.dataset.testId = a),
      (n.tabIndex = a + 1);
    let i = document.createElement("div");
    ...
    (r.className = "card_infoSpaceContainer card_dark"),
      (r.dataset.testId = "info-btn"),
      (r.innerHTML = '<p class="susu-pcons" translate="no">info</p>'),
      i.appendChild(r);
    let l = document.createElement("div");
    l.className = "card_cardDetails card_hideMobileInfoText";
    let c = document.createElement("div");
    ...
    return (
      (d.className = "card_cardSubText"),
      (d.dataset.testId = "card-subtext"),
      (d.textContent = "$0.00"),
      l.appendChild(c),
      l.appendChild(d),
      n.appendChild(i),
      ...
      n.addEventListener("click", (a) => {
        a.stopPropagation(), ea(e, t, n, s);
      }),
      n
    );
  }
  function et(e) {
    return e.replace(/_/g, " ").replace(".png", "");
  }
  function ea(e, t, a, s) {
    document.querySelectorAll(".card_cardImage.selected").forEach((e) => {
      e.classList.remove("selected");
    });
    let n = a.querySelector(".card_cardImage");
    n && n.classList.add("selected"), en(s + t), (d.texture = t);
  }
  function et(e) {
    return e.replace(/_/g, " ").replace(".png", "");
  }
        ...
        if (t.classList.contains(l)) {
          t.classList.remove(l),
            ...
            ec.includes(s)
              ...
              : ed.includes(s) && (d.design.jacket.PocketsBottom = void 0),
            em(s);
          return;
        }
      }
      ...
      if (
        ...
        "Back" === a
          ? (function e() {
              ...
              let t = o + Math.PI - (g.rotation.y - N);
              (t %= 2 * Math.PI),
                BABYLON.Animation.CreateAndStartAnimation(
        ...
        m && !m.classList.contains("active") ? m.click() : er();
      }
    }
  }
  (u = j()),
  ...
  let ec = ["4on2_pocket_4", "4on2_pocket_5", "4on2_pocket_6"],
    ed = [
      "4on2_pocket_1",
      "4on2_pocket_2",
      "4on2_pocket_3",
  ...
  function ep(e) {
    ...
    if (
      ("top" === e
        ? (a = t.filter((e) => ec.includes(e.meshName)))
        : "bottom" === e && (a = t.filter((e) => ed.includes(e.meshName))),
      "top" === e)
    ) {
  ...
  function eu(e) {
    ...
    if (a) {
      ...
      ec.includes(e)
        ...
        : ed.includes(e) && (s = "selected-bottom-pocket"),
        a.classList.remove(
          "selected-back",
          "selected-lapel",
          "selected-top-pocket",
    ...
    if (window.matchMedia("(max-width: 1024.9px)").matches) {
      ...
      r
        ? d.design.jacket.PocketsTop === t
          ...
          : (ec.forEach((e) => em(e)), eu(t), (d.design.jacket.PocketsTop = t))
        : l &&
          (d.design.jacket.PocketsBottom === t
  ...
  function e$(e) {
    ...
    o && "none" !== o.style.display && (eb(), (o.style.display = "block"));
  }
  function ek(e, t) {
    ...
    for (
      ...
      (k = e[y]),
        (g = (r[y] / 100) * o[y]),
        ($ = (h = k.offsetLeft + g - n) + o[y] * gsap.getProperty(k, "scaleX")),
        a
          .to(k, { xPercent: d(((g - $) / o[y]) * 100), duration: $ / c }, 0)
          .fromTo(
            k,
            { xPercent: d(((g - $ + u) / o[y]) * 100) },
            {
              xPercent: r[y],
              duration: (g - $ + u - g) / c,
              immediateRender: !1,
  ...
  function e_() {
    ...
    e.forEach((e) => {
      ...
      let t = gsap.utils.toArray(".card_cardContainer", e),
        a = ek(t, { paused: !0, draggable: !0, speed: 2, snap: 1 });
      a.progress(0, !1),
        gsap.set(e, { x: 0 }),
  ...
  function e3(e, t) {
    switch (e) {
      ...
      case "Pockets":
        if (ec.includes(t)) return "selected-top-pocket";
        if (ed.includes(t)) return "selected-bottom-pocket";
...
`;
  ...
  let e1 = document.getElementById("arrow");
  e1
